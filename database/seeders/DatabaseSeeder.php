...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $moroccanCities = [
            ...
            'Fes' => ['Fes El Bali', 'Fes Jdid', 'Agdal', 'Sais', 'Zouagha', 'Dar Dbibegh', 'Jnane Sbile',
                'Mont Fleuri', 'Laymoune', 'Oued Fes', 'Bensouda', 'Ain Kadous', 'Ras El Ma'],
            'Tangier' => ['Marshan', 'Iberia', 'Malabata', 'Charf', 'Beni Makada', 'Ziaten', 'Dradeb',
            ...
            'Mohammedia' => ['Hay Al Alia', 'Hay Al Amal', 'Hay Al Wafa', 'Sablettes', 'Casabarata',
